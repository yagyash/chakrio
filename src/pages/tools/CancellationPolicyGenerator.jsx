          ...
          <div className="bg-surface rounded-2xl border border-surface3 p-8 mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={copyToClipboard}
                style={{ background: copied ? 'rgba(76,175,80,0.15)' : 'rgba(201,162,75,0.12)', color: copied ? '#4CAF50' : '#C9A24B', border: `1px solid ${copied ? 'rgba(76,175,80,0.3)' : 'rgba(201,162,75,0.25)'}`, borderRadius: '10px', padding: '8px 16px', fontSize: '13px', fontWeight: 600, cursor: 'pointer', transition: 'all 0.2s' }}>
